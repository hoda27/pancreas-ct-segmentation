...
| ------------- | ------------: | ----------------: |
| **Dice**      | 0.840 ± 0.002 | **0.890 ± 0.003** |
| **Precision** | 0.850 ± 0.003 | **0.890 ± 0.004** |
| **Recall**    | 0.870 ± 0.004 | **0.888 ± 0.004** |
...
```bash
git clone https://github.com/hoda27/pancreas-ct-segmentation.git
...
Master's Research Project, Medical Image Segmentation & Deep Learning
